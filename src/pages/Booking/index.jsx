...
const Booking = () => {
  return (
    <div className="flex flex-col py-14 justify-between bg-[#0022431b] border border-solid border-black">
      ...
      <div className="my-6 flex justify-center">
        <div className="w-3/4 p-4 flex flex-col rounded-2xl bg-white">
